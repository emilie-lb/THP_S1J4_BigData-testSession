...
def array_size
	puts "Combien de journalistes dans ce array?"
	puts $array.size
end
...
def other_question
	puts = "Veux-tu savoir autre chose?"
end
...
#array.slice(1,2) => affiche les entrée 1 et 2 du tableau
#array.take(2) => affiche les 2 premières entrées du tableau
